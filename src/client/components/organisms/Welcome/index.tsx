    ...
    <>
      <div className="flex justify-between py-20 px-10 gap-x-5 bg-indigo-600 text-indigo-100">
        <div className="md:w-1/2 mb-10 md:mb-0 text-center md:text-start">
          ...
          <a
            href="#"
            className="inline-block py-2 px-5 text-lg bg-gray-400 rounded text-gray-800 hover:bg-gray-200 mr-2"
          >
            Saber Mais
          </a>
          <Link
            href="/apolice/create"
            className="mt-2 mb:mt-0 inline-block py-2 px-5 text-lg bg-yellow-500 text-yellow-800 rounded hover:bg-yellow-300"
          >
            Criar Apólice
          </Link>
        </div>
